  ...
  <Layout>
    ...
    <Section>
        <h2 style={{"text-align": "center"}}>
            <img src="https://i0.wp.com/cdn.jotfor.ms/img/check-icon.png?resize=128%2C128&amp;ssl=1" alt="" width="128" height="128" />
            <br/>
            Thank You!
        </h2>
                                        ...
                                        <tr>
                                            <td>
                                                <select name="os0">
                                                    ...
                                                    <option value="Art / Craft Electric">Art / Craft Electric $126.00 USD</option>
                                                    <option value="Non-Profit">Non-Profit $71.00 USD</option>
                                                    <option value="Non-Profit Electric">Non-Profit Electric $106.00 USD</option>
                                                    <option value="Commercial Vendors">Commercial Vendors $156.00 USD</option>
                                                    <option value="Commercial Vendors Electric">Commercial Vendors Electric $191.00 USD</option>
                                                    <option value="Food / Drink Vendors">Food / Drink Vendors $181.00 USD</option>
                                                    <option value="Food / Drink Vendors Electric">Food / Drink Vendors Electric $216.00 USD</option>
                                                </select>
                                            </td>
                                        </tr>
                                    </tbody>
